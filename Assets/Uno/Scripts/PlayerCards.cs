...
public class PlayerCards : MonoBehaviour
{
    ...
    public List<Card> AllowOddCards
    {
        get
        {
            List<Card> e = cards.FindAll(
                (obj) =>
                {
                    return obj.IsAllowOddCard();
                });
            return e;
        }
    }
    public List<Card> DisallowedOddCard
    {
        get
        {
            List<Card> e = cards.FindAll(
    ...
    public List<Card> AllowEvenCards
    {
        get
        {
            List<Card> e = cards.FindAll(
                (obj) =>
                {
                    return obj.IsAllowEvenCard();
                });
            return e;
        }
    }
    public List<Card> DisallowedEvenCard
    {
        get
        {
            List<Card> e = cards.FindAll(
    ...
    public List<Card> AllowDoubleCards
    {
        get
        {
            List<Card> e = cards.FindAll(
                (obj) =>
                {
                    return obj.IsDoubleCards();
                });
            return e;
        }
    }
    public List<Card> DisallowDoubleCards
    {
        get
        {
            List<Card> e = cards.FindAll(
    ...
    public List<Card> AllowSequentialCards
    {
        get
        {
            List<Card> e = cards.FindAll(
                (obj) =>
                {
                    return obj.IsSequentialCards();
                });
            return e;
        }
    }
    public List<Card> DisallowSequentialCards
    {
        get
        {
            List<Card> e = cards.FindAll(
